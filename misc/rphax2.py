...
def main():
    ...
    generate_parser.add_argument("input_file", help = "Input .tlv file", type=str,default=None)
    ...
    #if(args.input_mfile != None):
    #    makerchip_create(args.input_mfile,args.from_url)
