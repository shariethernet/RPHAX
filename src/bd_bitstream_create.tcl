...
puts "printing 2nd outputdir"
puts $output_dir
puts $$output_dir//inv_ip2//inv_ip2.srcs//sources_1//new
#import_files "$output_dir/inv_ip2/inv_p2.xpr"
...
set_property  ip_repo_paths  {ip/inv_ip2/inv_ip2.srcs/sources_1/new} [current_project]
update_ip_catalog
#set_property  ip_repo_paths  "$output_dir/inv_ip2" [current_project]
#update_ip_catalog
...
########### Upgrade IP
export_ip_user_files -of_objects [get_ips design_1_inverter_0_0] -no_script -sync -force -quiet

##### GenerateTop Level Wrapper

make_wrapper -files [get_files $pwdd/myproj/project_1.srcs/sources_1/bd/design_1/design_1.bd] -top

add_files -norecurse $pwdd/myproj/project_1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
