...
################################################################
# This is a generated script based on design: adds
#
...
# <./adds/adds.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project adds adds -part xc7z020clg400-1
}
...
xilinx.com:user:axis_adder:1.0\
...
proc create_root_design { parentCell } {
  ...
  set axis_adder_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axis_adder:1.0 axis_adder_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_adder_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_adder_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_adder_0/M00_AXIS]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axis_adder_0/m00_axis_aresetn] [get_bd_pins axis_adder_0/s00_axis_aresetn] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn]
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axis_adder_0/m00_axis_aclk] [get_bd_pins axis_adder_0/s00_axis_aclk] [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins ps7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_fclk0/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ps7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_ps7_0_HP0_DDR_LOWOCM
  ...
  set_property PFM_NAME {xilinx.com:xd:adds:1.0} [get_files [current_bd_design].bd]
