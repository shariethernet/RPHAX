...
################################################################
# This is a generated script based on design: add
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_adder_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_adder_0/s00_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn]
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins axi_adder_0/s00_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins ps7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_fclk0/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs axi_adder_0/S00_AXI/S00_AXI_reg] SEG_axi_adder_0_S00_AXI_reg
